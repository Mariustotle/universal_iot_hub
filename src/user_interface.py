...
class UserInterface:
    ...
    async def main_menu(self):
        while not self.completed:            
            ...
            if choice == "1":
                ...
                DisplayHelper.print_pin_table(self.catalog.device.get_pin_display_matrix(), self.catalog.device.device_pins, self.catalog.device.name, color="cyan")
    ...
    async def sensor_action_menu(self, sensor:Sensor):
        ...
        while not self.completed:
            ...
            if choice.lower() == 'i':
                DisplayHelper.print_pin_table(sensor.get_pin_display_matrix(), sensor.pins, sensor.name, color="cyan")
                input("Press Enter to continue...")
    ...
    async def actuator_action_menu(self, actuator:Actuator):
        while not self.completed:
            ...
            if choice.lower() == 'i':
                DisplayHelper.print_pin_table(actuator.get_pin_display_matrix(), actuator.pins, actuator.name, color="cyan")
                input("Press Enter to continue...")
